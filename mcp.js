  ...
  switch (method) {
    ...
    case 'tools/call': {
      ...
      try {
        ...
        } else if (name === 'lawbor_post_job' || name === 'lawbor_bid' || name === 'lawbor_award' || name === 'lawbor_settle' || name === 'lawbor_validate' || name === 'lawbor_offer') {
          const kind = name === 'lawbor_post_job' ? 'help_wanted' : name === 'lawbor_bid' ? 'bid'
            : name === 'lawbor_settle' ? 'settle' : name === 'lawbor_validate' ? 'validate' : name === 'lawbor_offer' ? 'offer' : 'award';
